...
EC-Schnorr-INDRAv0 that is described herein.  The signatures and implementation
...
named EC-Schnorr-INDRAv0 suitable for use in Decred.
...
# EC-Schnorr-INDRAv0 Specification
...
EC-Schnorr-INDRAv0 that can be made to further harden security for multi-party and
