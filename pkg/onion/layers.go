...
func (o Skins) ForwardCrypt(s *traffic.Session, k *prv.Key,
	...
	return o.Forward(s.Peer.AddrPort).Crypt(s.HeaderPub, k, n)
}

func (o Skins) ReverseCrypt(s *traffic.Session, k *prv.Key,
	n nonce.IV) Skins {

	return o.Reverse(s.Peer.AddrPort).Crypt(s.HeaderPub, k, n)
}
...
func (o Skins) Crypt(to *pub.Key, from *prv.Key,
	n nonce.IV) Skins {
...
func (o Skins) Token(tok sha256.Hash) Skins {
	return append(o, (*token.Layer)(&tok))
}
