...
// NewPeerstore creates an in-memory thread-safe collection of peers. It's the
// caller's responsibility to call RemovePeer to ensure that memory consumption
// of the peerstore doesn't grow unboundedly.
