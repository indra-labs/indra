...
and curve25519 for the ECDH key exchange, and encrypt traffic with AES-GCM.
Rolling over encryption ciphers is done partly via hash chains and can also be
periodically triggered in return messages from circuit exit points.
